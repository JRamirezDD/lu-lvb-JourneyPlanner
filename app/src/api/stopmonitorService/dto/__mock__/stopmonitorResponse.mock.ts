import { MonitorResponse, DirectionResponse, StopsResponse, StopTimesResponse } from "../stopmonitorResponse";
...
export const mockDirectionResponse: DirectionResponse = {
    items: [
        {
            directionId: "0",
            agencyName: "Leipziger Verkehrsbetriebe",
...
export const mockStopsResponse: StopsResponse = {
    items: [
        {
...
export const mockStopTimesResponse: StopTimesResponse = {
    tripInfo: {
        trip_id: "lvb12345",
